...
replace github.com/shutter-network/rolling-shutter/rolling-shutter v0.0.7 => ./packages/rolling-shutter/rolling-shutter

replace github.com/shutter-network/shop-contracts v0.0.1 => ./packages/shop-contracts
